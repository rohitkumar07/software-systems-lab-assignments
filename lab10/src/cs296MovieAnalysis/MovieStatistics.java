...
public class MovieStatistics implements MovieStatAbstract{
	...
	/**
	 * This function maps name of characters to the frequency of its appearance in script.
	 * 
	 * \brief Implemetation of this function:
	 * 
	 * Firstly this function parses through the whole script and through the narration part of the script,
	 *  it identifies the main characters. Words which don't make any sense are not included in this through 
	 * a filter applied on it.
	 * 
	 * @return Map<String, Integer> The map of characters and their frequency.
	 * @throws IOException
	 */
...
//		gender//
	 ...
	 *  
	 * @param m Map storing the movie characters and their frequency
	...
	/**
	 * sortMovieCharacters() uses the function sortByComparator(Map<String, Integer> m) to 
	 * sort Map<String, Integer>, and then returns a map of character names with their frequency, 
	...
	public void printCharCounts() throws IOException {
		Map<String, Integer> movieCharsCount =  sortMovieCharacters();
		System.out.println("\n//----------PRINTING CHARACTERS WITH THEIR RESPECTIVE COUNTS----------\\\\");
		System.out.println("\nNAME \t\t\t"+"COUNT \t\t\t");
	...
	/**
	 * 
	 * Prints the character count with gender in a tabular form
	 * 
	 * @throws IOException
	 * */
	public void printCharCountsWithGender() throws IOException {
		...
		int index  = 0;
		System.out.println("\n//-----PRINTING CHARACTERS WITH THEIR RESPECTIVE COUNTS AND GENDER------\\\\");
		System.out.println("\nNAME \t\t\t"+"COUNT \t\t\t"+"GENDER \t \t\n");
		for (Entry<String, Integer> entry : movieCharsCount.entrySet()) {
			String temp = entry.getKey();
